...
import (
	...
	"github.com/gkwa/alittlebitrover/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.alittlebitrover.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".alittlebitrover")
	}
